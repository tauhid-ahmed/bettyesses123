...
function Footer() {
  ...
  return (
    <footer>
      <Container>
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-20 py-8 md:py-12">
              ...
              <ul className="space-y-3">
                {footerData.quickLinks.links.map((link, index) => (
                  <li key={index}>
                    <a
                      href={link.href}
                      className="text-gray-700 hover:text-purple-600 transition-colors duration-200 text-sm block py-1"
                    >
                      {link.name}
                    </a>
                  </li>
            ...
            <div className="space-y-4 sm:col-span-2 lg:col-span-1">
              ...
              <div className="space-y-3">
                <a
                  ...
                  className="flex items-center space-x-3 text-gray-700 hover:text-purple-600 transition-colors duration-200 text-sm py-1"
                >
                  <svg
                ...
                <a
                  ...
                  className="flex items-start space-x-3 text-gray-700 hover:text-purple-600 transition-colors duration-200 text-sm py-1"
                >
                  <svg
        ...
        {/* Bottom Bar */}
        <div className="pt-6 md:pt-8 border-t border-purple-200">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0">
            <p className="text-sm text-gray-600 text-center sm:text-left">
              © 2024 Logo Ipsum. All rights reserved.
            </p>
